    ...
    <>
      ...
      <div className="mt-6 flex">
        ...
        <input
          ...
          required
          maxLength={30}
          className="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(--spacing(2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:outline-hidden sm:text-sm dark:border-zinc-700 dark:bg-zinc-700/15 dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400/10"
        />
        <button
          ...
          onClick={() => sendEmail(CONTACT_EMAIL, subject)}
        >
          Contact me
        </button>
      </div>
