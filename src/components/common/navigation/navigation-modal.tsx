...
export const NavigationModal = (props: PropsWithChildren<Props>): ReactElement => {
  ...
  return <>
    <div className={'pointer-events-auto mx-2 md:hidden justify-end flex'}>
      <button
        className={'group flex items-center rounded-xl bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20'}
        type={'button'}
        aria-expanded={true}
      ...
      >
        ...
        >
          <path d={ArrowDownIcon.svgPath} fill={'none'} strokeWidth={1.5} strokeLinecap={'round'}
      ...
      <div>
        ...
        <div
          className={'fixed inset-x-4 top-8 z-50 origin-top rounded-xl bg-white p-8 ring-1 ring-zinc-900/5 dark:bg-zinc-900 dark:ring-zinc-800 opacity-100 scale-100 '
            + (!visible ? 'hidden' : '')}
          tabIndex={-1}>
