    ...
    return (
      <article key={key} className={"group relative flex flex-col items-start"}>
        ...
        >
          <div
            className={
              "absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 dark:bg-zinc-800/50 sm:-inset-x-6 sm:rounded-xl"
            }
          ></div>
          {_renderLink(item)}
        </h3>
