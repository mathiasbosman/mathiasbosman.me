    ...
    return html`
      <form action="/thank-you"
        ...
        <h2 class="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
          ...
          <span class="ml-3">Contact me</span></h2>
        <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          Fill in your email address and I will get in touch.</p>
        <div class="mt-6 flex"><input type="email"
        ...
        <p class="mt-2 text-sm text-zinc-600 italic dark:text-zinc-400">Or email me directly.</p>
      </form>
    `
  }
}
