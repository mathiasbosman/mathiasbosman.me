...
export const Projects = (props: PropsWithChildren<Props>): ReactElement => {
  function _renderItem (project: Project, key: number): ReactElement {
    return <article key={key} className={'group relative flex flex-col'}>
      <div
      ...
      <p
        className={'relative z-10 mt-6 flex text-sm font-medium text-zinc-400 contrast-more:text-zinc-500 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-violet-400 group-hover:to-pink-600'}>
