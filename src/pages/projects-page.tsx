        ...
        <SectionWrapper>
          <div className={"mx-auto max-w-2xl lg:max-w-5xl"}>
            ...
            <p className={"mt-6 text-base text-zinc-600 dark:text-zinc-400"}>
              I&apos;ve worked on tons of little projects over the years that led to nothing but
              these are the ones that are worth mentioning or that are re-usable. All of them are
