        ...
        <sandbox-content>
          <div class="relative px-4 sm:px-8 lg:px-12">
            ...
            <div class="flex gap-6">
              <!-- socials -->
              <sandbox-social-icon-link .link="${LINK_GITHUB}"
                                        .icon="${GitHubIcon}"></sandbox-social-icon-link>
              <sandbox-social-icon-link .link="${LINK_LINKEDIN}"
                                        .icon="${LinkedInIcon}"></sandbox-social-icon-link>
            </div>
          </div>
        </sandbox-content>
                  ...
                  <div
                    ...
                    <sandbox-employment>
                        ...
                        <sandbox-employment-item
                            ...
                            company="Echoweb"
                            role="PHP developer"
                            since="2013" until="2013"></sandbox-employment-item>
                        <sandbox-employment-item
                            .logo="${{
                            ...
                            since="2012" until="2012"></sandbox-employment-item>
                    </sandbox-employment>
                  </div>
                </div>
              </div>
