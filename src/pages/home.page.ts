        ...
        <div class="relative">
          <main>
              ...
              <sandbox-content>
                <div class="relative px-4 sm:px-8 lg:px-12">
                  ...
                  <div class="flex gap-6">
                    <!-- socials -->
                    <sandbox-social-icon-link href="https://github.com" .config="${GitHubIcon}"></sandbox-social-icon-link>
                    <sandbox-social-icon-link href="https://github.com" .config="${LinkedInIcon}"></sandbox-social-icon-link>
                  </div>
                </div>
              </sandbox-content>
            </div>
            ...
            <sandbox-image-carousel .images="${[
              { alt: 'Stage lights in xxx for a performance of Disney\'s Newsies', src: roll_2 },
              { alt: 'Luna, my favourite Beagle', src: roll_1 },
              { alt: 'Phantasialand. Theme parks are just a hobby, I promise', src: roll_3 },
              { alt: 'Enjoying a sail trip in Curacao', src: roll_5 },
              { alt: 'Me on a stage during Pride week', src: roll_4 }
                    ...
                    <div class="space-y-10 lg:pl-16 xl:pl-24">
                      ...
                      <div
                        ...
                        <ol class="mt-6 space-y-4">
                          <li>
                            <sandbox-employment 
                                .logo="${{ alt: 'Flemish Government logo', src: logo_flemish_gov }}"
                          ...
                          <li>
                            <sandbox-employment
                                .logo="${{ alt: 'Echoweb logo', src: logo_echoweb }}"
                                company="Echoweb"
                                role="PHP developer"
                          ...
                          <li>
                            <sandbox-employment
                                .logo="${{ alt: 'Procius Ltd. logo', src: logo_procius }}"
                                company="Procius Ltd."
                                role="PHP developer (internship)"
                                since="2012" until="2012"></sandbox-employment>
                          </li>
                        </ol>
                        <sandbox-download-button .link="${{ href: '#', text: 'Download CV' }}"></sandbox-download-button>
                      </div>
                    </div>
                  </div>
                </section>
